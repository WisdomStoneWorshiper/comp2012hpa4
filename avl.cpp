...
AVLNode *AVL::insert(AVLNode *root, Vertex *target, const int &d)
{
    if (root == nullptr)
...
void AVL::insert(Vertex *target, const int &d)
{
...
AVLNode *AVL::remove(AVLNode *root, Vertex *target, const int &d)
{
    if (root == nullptr)
        return nullptr;
    if (d < root->distance)
...
void AVL::remove(Vertex *target, const int &d)
{
